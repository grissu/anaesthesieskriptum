...
:   1.  Proximaler Tubulus:
    komplette Glucoserückaufnahme im Symport mit Na, 60-70% Wasserrücktransport, Harnstoff + Phosphat+Cl+HCO3Reabsorption.

    CAVE: Carboanhydrasehemmer verhindern Bicarbonatrücktransfer und damit auch Wasserrückresorption), Sekretion von Säuren und Basen.
2.  Henle Schleife:
