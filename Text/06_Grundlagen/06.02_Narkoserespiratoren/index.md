...
:   keine Rückführung des ausgeatmeten Gases, es wird direkt an die Umgebung abgegeben, daher hoher Gasverbrauch, Wärme- und Feuchtigkeitsverlust
    ...
    häufig ausserhalb des OPs, z.B. bei Intensiv-Beatmungsgeräten (Hauptaugenmerk auf Langzeitbeatmung, keine Narkosegase).
    Benötigen Vorwärmung und Befeuchtung durch **Heat and Moisture Unit** bei Langzeitanwendung.
...
:   (fast) vollständige Rückatmung des ausgeatmeten Gases (Recycling).
    Probleme:

    1.  Kohlendioxid muss durch einen Absorber ({ref}`Atemkalk <Atemkalk>`) entfernt werden.
...
-   **Sauerstoffmangelsignal**:
    ...
    Es muss mindestens 7 Sekunden dauern und mind. 2 dB über weißem Rauschen von 50 db liegen.
...
Geeignet für: Halothane, Enflurane, Isoflurane, Sevoflurane;
